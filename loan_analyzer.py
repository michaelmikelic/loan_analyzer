...
print("The total value of all the loans combined is:", total_loan_value)

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_amount = total_loan_value / total_loans
print("The average amount for each loan is:", average_loan_amount)
...
print("The remaining months for the loan are:", remaining_months)
...
present_value = future_value / ((1 + loan_discount_rate/12) ** remaining_months)
...
if present_value >= loan_price:
    ...
    print("This loan is to expensive and not worth the price!")
